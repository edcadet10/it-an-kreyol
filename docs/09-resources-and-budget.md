...
Detailed effort analysis is a preparation control. Audience-performance measurement remains blacked out until after Day 30.

## Provisional resource inventory
...
## Provisional cash baseline

**Release 1 cash ceiling: $0 until sponsor review.** This is a planning assumption, not a claim that quality production is always free.

| Category | Baseline | Approval rule |
|---|---:|---|
| Existing phone/computer | $0 incremental | Use current equipment |
| Editing/caption tool | $0 incremental | Free/current tool unless a documented blocker exists |
...
Exact days and hours are entered only after sponsor confirmation.

## Information and asset management

| Information | Location rule | Public? |
|---|---|---|
| Management docs, empty templates, public sources | GitHub repository | Yes |
| Final public scripts/captions | GitHub after review | Yes |
| Raw video and project masters | Private working storage with backup | No by default |
| TikTok credentials/recovery codes | Password manager / secure offline recovery | Never |
| Private analytics export | Private analysis storage | No |
| Aggregated/de-identified results | Repository evaluation report | Yes |
| Interview consent/contact details | Private access-controlled notes | No |
| De-identified learning findings | Repository | Yes |

## Cost and capacity variance
