...
## PM lesson: milestone versus task

A task consumes effort; a milestone marks a meaningful zero-duration event, such as “seven videos ready.” A gate is a decision point that requires evidence. A deadline without entry/exit evidence is merely a date.
